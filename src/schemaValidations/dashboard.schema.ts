...
// Schema cho từng sản phẩm trong Top 5
...
// Schema cho response của API get-top5-products-sold
...
// Schema cho sản phẩm trong response AI recommend
