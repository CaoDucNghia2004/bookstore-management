...
interface TopProductsSectionProps {
    ...
    maxDisplay?: number; // Số lượng hiển thị tối đa mỗi lần
}
...
// Component hiển thị từng sản phẩm - Vertical Card đẹp
...
// Component compact cho dropdown search
...
export default function TopProductsSection({
    ...
    // Gọi Top 5 khi chưa đăng nhập
    const { data: top5Data, isLoading: top5Loading } = useTop5ProductsSold();

    // Gọi AI recommend khi đã đăng nhập
    ...
    // Handler khi click vào sản phẩm từ AI recommend -> gọi feedback "view"
    ...
    // Compact variant cho dropdown search - giới hạn 5 sản phẩm
    if (variant === "compact") {
